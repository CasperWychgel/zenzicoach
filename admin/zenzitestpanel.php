...
<section class="scrolling-wrapper" id="customertable">
    <div class="row">
        <div class="">
            <form method="post" action="delete.php" id="checkdelete">
                <table id="customer" class="table centered highlight ">
                    <thead>
                    <tr>
                        <th>Customer ID</th>
                        <th>Voornaam</th>
                    ...
                    while ($row = mysqli_fetch_array($query)) { ?>
                        <tr>
                            ...
                            <td><a class="btn waves-effect waves-light grey darken-3" href="detail.php?id= <?php echo $row['id'] ?> " >Details</a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>

...
<section id="textinfo">
    <div class="section white">
        <div class="row container">
            <h2 class="header center-align">Contact</h2>
            <p class="flow-text center-align grey-text text-darken-3 lighten-3">
                ZenziCoach <br>
                Dorpstraat 47 <br>
                4661 HM Halsteren <br>
                info@zenzicoach.nl <br>
                <br><br>
                Ter info: Bellen is voor mij lastig omdat ik vaak met cliënten in gesprek ben en ik daar 100% de aandacht voor wil hebben, als je wilt dat ik je bel vermeld dat even dan bel ik je op een rustig tijdstip terug.
            </p>
        </div>
    </div>
</section>
